...
export function renderStep6(data = {}) {
    ...
    <div class="step-content animate-fade-in" data-node-id="62:8040">
        ...
        <div class="mb-10">
            ...
            <p class="text-sm text-body mb-6">Specify the check-in & check-out time at your property</p>
        ...
        <div class="mb-10">
            ...
            <p class="text-sm text-body mb-6">Define when and how much guests should pay.</p>

            <div class="bg-neutral-secondary rounded-lg p-6 mb-6 border border-default">
                <div id="payment-policy-list" class="flex flex-col mb-6">
                    ${paymentPolicies.map((policy, index) => renderPaymentPolicyItem(policy, index)).join('<hr class="border-gray-200" style="margin: 16px 0;" />')}
                </div>
                
                 <button id="add-payment-policy" type="button" class="btn bg-gray-900 text-white hover:bg-gray-800 px-6 py-3 rounded-lg flex items-center gap-2 transition-colors">
        ...
        <div class="mb-10">
            ...
            <p class="text-sm text-body mb-6">Offering a flexible cancellation policy helps traveller book in advance.</p>

            <div class="bg-neutral-secondary rounded-lg p-6 mb-6 border border-default">
                 <div id="cancellation-policy-list" class="flex flex-col mb-6">
                ...
                <button id="add-cancellation-policy" type="button" class="btn bg-gray-900 text-white hover:bg-gray-800 px-6 py-3 rounded-lg flex items-center gap-2 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                    Add Policy
                </button>
            </div>
...
function renderPaymentPolicyItem(policy, index) {
    ...
    <div class="payment-policy-item" data-id="${policy.id}">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="policy-badge bg-cyan-50 text-xs font-medium p-1 rounded border border-cyan-100" style="color: var(--text-fg-brand-strong);" data-id="${policy.id}">
        ...
        <div class="flex flex-row gap-4 items-end">
            ...
            <div class="w-[22%]">
             ...
             <div class="w-[6%] flex justify-end pb-2">
                <button type="button" class="remove-payment-policy text-gray-400 hover:text-red-600 transition-colors p-2 rounded-full hover:bg-gray-100" data-id="${policy.id}" title="Remove policy">
        ...
        <div class="flex justify-between items-center mb-4">
         ...
         <div class="flex flex-row gap-4 items-end">
            ...
            <div class="w-[22%]">
             ...
             <div class="w-[6%] flex justify-end pb-2">
                <button type="button" class="remove-cancellation-policy text-gray-400 hover:text-red-600 transition-colors p-2 rounded-full hover:bg-gray-100" data-id="${policy.id}" title="Remove policy">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                </button>
            </div>
        </div>
