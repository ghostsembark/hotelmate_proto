...
export function renderStep7(data) {
    ...
    <div class="step-content animate-fade-in">
        <div class="step-header legacy-mb-8">
            <h2 class="heading-2xl legacy-mb-2">Verification</h2>
            <p class="body-base text-body-subtle">Verify your property to start accepting bookings.</p>
        </div>
        
        <div class="legacy-w-full">
            <div class="card legacy-p-6 legacy-bg-white legacy-border border-gray-200 legacy-rounded-lg legacy-shadow-sm">
                <!-- No GST Checkbox -->
                <div class="legacy-mb-6">
                    <label class="legacy-flex legacy-items-center legacy-gap-3 cursor-pointer group select-none">
                        <input type="checkbox" id="no-gst-checkbox" class="w-5 h-5 legacy-rounded border-gray-300 text-brand focus:ring-brand cursor-pointer" ${noGst ? 'checked' : ''}>
                ...
                <div id="gst-section" class="${noGst ? 'hidden' : 'block'} transition-all duration-300 ease-in-out">
                        ...
                        <!-- File Upload -->
                        <div class="legacy-mb-2">
                        <label class="legacy-block label-base legacy-mb-2">Upload GST Certificate</label>
                        <div class="border-2 border-dashed border-gray-300 legacy-rounded-lg legacy-p-8 legacy-text-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer legacy-relative" id="upload-area">
                            <div class="legacy-flex legacy-flex-col legacy-items-center pointer-events-none">
                            ...
                            <input type="file" id="gst-file" class="legacy-absolute legacy-inset-0 legacy-w-full legacy-h-full opacity-0 cursor-pointer" accept=".pdf,.png,.jpg,.jpeg">
                        </div>
                        </div>
                        
                        <!-- File Preview -->
                        <div id="file-preview" class="legacy-mt-4 ${data.gstFileName ? '' : 'hidden'}">
